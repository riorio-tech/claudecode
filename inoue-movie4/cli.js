...
program
  ...
  .option('--template <name>', 'テンプレート動画名（templates/{name}.mp4 を使用）（必須）')
  .option('--count <n>', '生成本数（デフォルト: 1）', parseInt)
  .option('--test-clips <n>', 'テスト用: 最初の N クリップのみコンポジット', parseInt)
